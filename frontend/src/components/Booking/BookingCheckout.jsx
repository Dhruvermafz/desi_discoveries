                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="product-name">
                        <a href="shop-product-details.html">Headphone</a> x 2
                      </td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td class="product-name">
                        <a href="shop-product-details.html">Lagage</a> x 3
                      </td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td class="product-name">
                        <a href="shop-product-details.html">Watch</a> x 1
                      </td>
                      <td>
                    ...
                    <li class="accordion block active-block">
                      <div class="acc-btn active">
                        <div class="icon-outer">
                          <i class="lnr-icon-chevron-down"></i>
                        </div>
